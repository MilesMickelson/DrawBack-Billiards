...
const Form = props => {
  ...
  const formProps = {
    // These are mainly default values for the server rendering. Otherwise the form would submit potentially sensitive data with the default GET method until the client side code is loaded.
    method: 'post',
    action: '/',
