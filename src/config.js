...
// ! If you want to change the language, remember to also change the locale data and the messages in the app.js file.
const locale = 'en';
const i18n = {
  /*
    0: Sunday
...
const siteTitle = 'DrawBack Billiards';

// Twitter handle is needed in meta tags (twitter:site). Start it with '@' character
const siteTwitterHandle = '@DrawBack-Billiards';
